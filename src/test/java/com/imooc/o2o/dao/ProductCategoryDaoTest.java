...
public class ProductCategoryDaoTest extends BaseTest {
    ...
    public void testCDeleteProductCategory() throws Exception{
        long shopId = 1;
        List<ProductCategory> productCategoryList = productCategoryDao.queryProductCategoryList(shopId,1,1);
        for(ProductCategory pc : productCategoryList){
            if("牛奶".equals(pc.getProductCategoryName())|| "奶茶".equals(pc.getProductCategoryName())){
