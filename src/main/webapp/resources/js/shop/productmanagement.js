$(function () {
    //获取此店铺下的商品列表的URL
    var listUrl = '/njtkidMaven/shopadmin/getproductlistbyshop?pageIndex=1&pageSize=999';
    //商品下架URL
    var statusUrl = '/njtkidMaven/shopadmin/modifyproduct';
    getList();
